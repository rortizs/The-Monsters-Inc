...
class ModeloProductos{
	...
	static public function mdlMostrarStockProductos($tabla, $item, $valor, $orden){
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, codigo, id_proveedor, descripcion, imagen, stock, precio_compra, precio_venta) VALUES (:id_categoria, :codigo, :id_proveedor, :descripcion, :imagen, :stock, :precio_compra, :precio_venta)");
	...
	static public function mdlSumaTotalCompras($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT sum(stock * precio_compra) as total from $tabla");
